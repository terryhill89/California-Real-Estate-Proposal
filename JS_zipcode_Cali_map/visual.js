...
d3.json('dem.json')
  .then(data => {
    // Define the layers
    var medianhomevalue = L.layerGroup();
    var Incomepercapita = L.layerGroup();
    var Medianhouseholdincome = L.layerGroup();
        ...
        'Asian Population',
        'Hispanic Population',
        'Population identifying as 2+ races',
        'Percent of transit public transport'
